        ...
        <form class="form form-horizontal" action="" method="post"  enctype="multipart/form-data">
          ...
          <div class="section">
            <div class="section-body">
              ...
              <div class="form-group">
                <label class="col-md-3 control-label">Título do Filme :-</label>
                <div class="col-md-8">
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">                       
                  <select name="video_file_type" id="video_file_type" class="select2" required>
                        ...
                        <option value="server_url" <?php if(isset($_GET['movie_id']) && $row['movie_type']=='server_url'){ echo 'selected'; } ?>>URL ao vivo</option>
                        <option value="local" <?php if(isset($_GET['movie_id']) && $row['movie_type']=='local'){ echo 'selected'; } ?>>Sistema Local</option>
                        <option value="embedded_url" <?php if(isset($_GET['movie_id']) && $row['movie_type']=='embedded_url'){ echo 'selected'; } ?>>URL incorporada (Open Load, Very Stream, Daily motion, Vimeo)</option>
              ...
              <div id="movie_url_holder" class="form-group" style="display:none;">
                <label class="col-md-3 control-label">Informe a URL :-
                  <p class="field-note">(Esta é a URL de vídeo padrão no player do app)</p>
                </label>
                <div class="col-md-8">
              ...
              <div id="movie_local_holder" class="form-group" style="display:none;">
                <label class="col-md-3 control-label">Procurar Vídeo :-
                  <p class="field-note">(Este é o vídeo padrão no player do app)</p>
                </label>
                <div class="col-md-8">
                  <input type="file" name="video_local" value="" class="form-control video_local">
                    <?php 
                     ...
                     ?> 
                      <div style="word-break: break-all;"><label class="control-label">URL Atual :-</label><?php echo $file_path.'uploads/'.$row['movie_url']?></div><br>
                      <?php  
                    }
                    ?>
                    <div class="uploadPreview media-preview-box" style="<?php if(isset($_GET['movie_id']) && $row['movie_type']=='local'){ echo 'display: block;';}else{ echo 'display: none;';}?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">                       
                    <select name="quality_status" id="quality_status" class="select2">
                      <option value="false" <?=(isset($_GET['movie_id']) && $row['is_quality']=='false') ? 'selected="selected"' : ''?>>DESLIGADO</option>
                      <option value="true"<?=(isset($_GET['movie_id']) && $row['is_quality']=='true') ? 'selected="selected"' : ''?>>LIGADO</option>
                    </select>
                  </div>
                </div>
                ...
                <div id="quality_local" style="display: none;">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      ...
                      ?>
                      <div class="uploadPreview media-preview-box" style="<?php if(isset($_GET['movie_id']) && $row['movie_type']=='local' && $row['is_quality']=='true' && quality_info_data($row['id'], 'quality_480')!=''){ echo 'display: block;';}else{ echo 'display: none;';}?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      ...
                      ?>
                      <div class="uploadPreview media-preview-box" style="<?php if(isset($_GET['movie_id']) && $row['movie_type']=='local' && $row['is_quality']=='true' && quality_info_data($row['id'], 'quality_720')!=''){ echo 'display: block;';}else{ echo 'display: none;';}?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      ...
                      ?>
                      <div class="uploadPreview media-preview-box" style="<?php if(isset($_GET['movie_id']) && $row['movie_type']=='local' && $row['is_quality']=='true' && quality_info_data($row['id'], 'quality_1080')!=''){ echo 'display: block;';}else{ echo 'display: none;';}?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">                       
                    <select name="subtitle" id="subtitle" class="select2">
                      <option value="false" <?=(isset($_GET['movie_id']) && $row['subtitle']=='false') ? 'selected="selected"' : ''?>>DESLIGADO</option>
                      <option value="true"<?=(isset($_GET['movie_id']) && $row['subtitle']=='true') ? 'selected="selected"' : ''?>>LIGADO</option>
                    </select>
                  </div>
                </div>
              ...
              <div class="form-group">
                <div class="col-md-3">
                  <label class="control-label">Descrição do Filme :-</label>
                </div>
                <div class="col-md-8">
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <input type="text" name="director" id="director" class="form-control" value="<?php echo (isset($_GET['movie_id']) && isset($row['director'])) ? htmlspecialchars($row['director'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-3 control-label">Elenco :-</label>
                <div class="col-md-8">
                  <input type="text" name="casts" id="casts" class="form-control" placeholder="Nomes separados por vírgula" value="<?php echo (isset($_GET['movie_id']) && isset($row['casts'])) ? htmlspecialchars($row['casts'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-3 control-label">País :-</label>
                <div class="col-md-8">
                  <input type="text" name="country" id="country" class="form-control" value="<?php echo (isset($_GET['movie_id']) && isset($row['country'])) ? htmlspecialchars($row['country'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-3 control-label">Data de lançamento :-</label>
                <div class="col-md-8">
                  <input type="text" name="release_date" id="release_date" class="form-control" placeholder="AAAA-MM-DD" value="<?php echo (isset($_GET['movie_id']) && isset($row['release_date'])) ? htmlspecialchars($row['release_date'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                </div>
              </div>
